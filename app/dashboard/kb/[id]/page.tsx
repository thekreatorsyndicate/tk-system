...
export default function KBDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const kb = useStableQuery(api.knowledgeBases.getForDashboard, { id: id as any })
  const documents = useStableQuery(api.documents.list, { knowledgeBaseId: id as any })
  const moduleTree = useStableQuery(api.modules.getTreeForDashboard, { knowledgeBaseId: id as any })
